...
import com.gn.translateseas.databinding.FragmentTraduccionBinding;


public class FragmentTraduccion extends Fragment {

    private FragmentTraduccionBinding binding;
    private RecyclerView rvImagenes;
    private LottieAnimationView lottieTemp;
    private VolleyImages images;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        binding = FragmentTraduccionBinding.inflate(inflater, container, false);
